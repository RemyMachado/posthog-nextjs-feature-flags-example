import { ClientFeatureFlagsNative } from './client/ClientFeatureFlagsNative';
import { ClientFeatureFlagsStable } from './client/ClientFeatureFlagsStable';
    ...
    <div className="container mx-auto min-h-screen py-10 px-4">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <ClientFeatureFlagsNative />
          <ClientFeatureFlagsStable />
        </div>
      </div>
    </div>
  );
